  ...
  return (
    <Fade>
      <div className="bg-white rounded-lg shadow-md pt-12 pb-20 mx-4 sm:mx-2">
        <p className="text-clip text-xl sm:px-8 px-[15%] pb-3 font-light leading-normal">
          I'm Rashadul Haque, a motivated developer from Sweden, with a strong
        ...
        <p className="text-clip text-xl sm:px-8 px-[15%] py-3   font-light leading-normal">
          While exploring the backend realm, I have dabbled in Node.js and PHP
          and familiarized myself with frameworks such as Express.js and
          Laravel. These experiences have ignited my passion for building
